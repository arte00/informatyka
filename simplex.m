...
% wiersz wskaŸników dla pierwszej tablicy
...
while max(bot_row(2:6)) > 0
    ...
    % Zerowanie wartoœci w kolumnie kluczowej
    ...
    % Aktualizacja wiersza wskaŸników
...
fprintf("\nFirma osi¹gnie najwiêksze zyski je¿eli wyprodukuje %d litrów szamponu ", b(x1_index))
