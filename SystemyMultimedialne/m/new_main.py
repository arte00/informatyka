...
def encode_jpeg(_image, sampling, qy, qc):
    ...
    y_compressed = compress(Y, sampling, qy)
    cr_compressed = compress(Cr, sampling, qc)
    cb_compressed = compress(Cb, sampling, qc)
...
def decode_jpeg(y_compressed, cr_compressed, cb_compressed, sampling, qy, qc, info):
    ...
    y_decompressed = decompress(y_compressed, sampling, qy, info)
    cr_decompressed = decompress(cr_compressed, sampling, qc, info)
    cb_decompressed = decompress(cb_compressed, sampling, qc, info)
